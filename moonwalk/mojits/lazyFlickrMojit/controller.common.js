...
YUI.add('lazyFlickrMojit', function(Y, NAME) {
    ...
    Y.namespace('mojito.controllers')[NAME] = {
        ...
        lazy: function(ac) {
            ...
            ac.models.get('lazyFlickrMojitModelFoo').getData(query, function(err, data) {
                if (err) {
                    ac.error(err);
                    return;
                }
