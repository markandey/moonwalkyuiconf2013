...
YUI.add('simpleFlickrMojitModelFoo', function(Y, NAME) {

    /**
     * The simpleFlickrMojitModelFoo module.
     *
     * @module simpleFlickrMojit
     */

    /**
     * Constructor for the simpleFlickrMojitModelFoo class.
     *
     * @class simpleFlickrMojitModelFoo
     * @constructor
     */
