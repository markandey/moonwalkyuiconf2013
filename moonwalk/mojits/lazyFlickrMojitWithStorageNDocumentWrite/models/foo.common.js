...
YUI.add('lazyFlickrMojitWithStorageNDocumentWriteModelFoo', function(Y, NAME) {

    /**
     * The lazyFlickrMojitWithStorageNDocumentWriteModelFoo module.
     *
     * @module lazyFlickrMojitWithStorageNDocumentWrite
     */

    /**
     * Constructor for the lazyFlickrMojitWithStorageNDocumentWriteModelFoo class.
     *
     * @class lazyFlickrMojitWithStorageNDocumentWriteModelFoo
     * @constructor
     */
